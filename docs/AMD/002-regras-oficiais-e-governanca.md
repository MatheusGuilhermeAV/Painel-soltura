...
- **Git / GitHub:** **qualquer alteração no projeto** (humana ou por agente) exige **commit** antes de concluir o trabalho; **push** para o remoto quando possível. Detalhes obrigatórios em [005-git-github-commits-obrigatorios.md](005-git-github-commits-obrigatorios.md).
